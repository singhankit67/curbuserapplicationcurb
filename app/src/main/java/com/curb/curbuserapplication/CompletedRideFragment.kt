...
class CompletedRideFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        var view =  inflater.inflate(R.layout.fragment_completed_ride, container, false)
        recyclerViewForCompleted = view.findViewById(R.id.recycler_view_ride_history_completed)
        noCompletedRide = view.findViewById(R.id.no_ride_history_text_for_completed)
